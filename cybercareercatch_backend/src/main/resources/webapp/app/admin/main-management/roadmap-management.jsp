					...
					<c:choose>
						<c:when test="${jobNumber == 1}">
							<a href="${pageContext.request.contextPath}/admin/roadmapManagement.adfc?jobNumber=1"
								class="rm-tab rm-tab-active">공격</a>
						</c:when>
						<c:otherwise>
							<a href="${pageContext.request.contextPath}/admin/roadmapManagement.adfc?jobNumber=1"
								class="rm-tab">공격</a>
					...
					<c:choose>
						<c:when test="${jobNumber == 2}">
							<a href="${pageContext.request.contextPath}/admin/roadmapManagement.adfc?jobNumber=2"
								class="rm-tab rm-tab-active">방어전략</a>
						</c:when>
						<c:otherwise>
							<a href="${pageContext.request.contextPath}/admin/roadmapManagement.adfc?jobNumber=2"
								class="rm-tab">방어전략</a>
					...
					<c:choose>
						<c:when test="${jobNumber == 3}">
							<a href="${pageContext.request.contextPath}/admin/roadmapManagement.adfc?jobNumber=3"
								class="rm-tab rm-tab-active">보안 구축/개발</a>
						</c:when>
						<c:otherwise>
							<a href="${pageContext.request.contextPath}/admin/roadmapManagement.adfc?jobNumber=3"
								class="rm-tab">보안 구축/개발</a>
						</c:otherwise>
					</c:choose>
					...
					<c:choose>
						<c:when test="${jobNumber == 4}">
							<a href="${pageContext.request.contextPath}/admin/roadmapManagement.adfc?jobNumber=4"
								class="rm-tab rm-tab-active">기타</a>
						</c:when>
						<c:otherwise>
							<a href="${pageContext.request.contextPath}/admin/roadmapManagement.adfc?jobNumber=4"
								class="rm-tab">기타</a>
