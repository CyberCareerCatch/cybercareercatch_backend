...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/main/community/add-post.css">
</head>
...
<body>
	...
	<main class="cmw-wrap">
		<div class="cmw-top">
			...
			<a href="${pageContext.request.contextPath}/post/list.pfc"
				class="cmw-top-mv"> 자유게시판 목록으로 이동하기 </a>
		</div>

		<div class="cmw-pnl">
			<form action="${pageContext.request.contextPath}/post/writeOk.pfc"
				method="post" class="cmw-frm" id="postWriteForm">
	...
	<script
		src="${pageContext.request.contextPath}/assets/js/main/community/add-post.js"></script>
